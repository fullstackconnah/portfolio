    ...
    <div className="relative z-10 min-h-screen px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto mb-4 px-4">
          <p
            onClick={() => navigate(-1)}
            className="text-green-400 font-mono text-sm underline cursor-pointer hover:text-[#39FF14] transition"
          >
            &gt; return
          </p>
        </div>

        <div className="border border-[#39FF14] rounded-lg shadow-[0_0_10px_#39FF14] text-[#39FF14] font-mono overflow-hidden backdrop-blur-md">
          ...
          {[
            ...
            <div key={label} className="space-y-4 mb-12 bg-[#0c0c0c]/90 p-5 rounded-md border border-[#39FF14]/10 shadow-inner group transition-all">
              ...
              {/* Terminal-style header with divider */}
